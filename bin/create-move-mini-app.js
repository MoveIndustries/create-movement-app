...
if (!appName && !isTest) {
  ...
  console.log(chalk.yellow('Usage: npx github:yourusername/create-move-mini-app my-app-name'));
  console.log(chalk.yellow('   or: create-move-mini-app my-app-name'));
  process.exit(1);
}
...
createApp(appName || 'test-app', { isTest })
  .then(() => {
    if (!isTest) {
      console.log(chalk.green('✅ Mini app created successfully!'));
